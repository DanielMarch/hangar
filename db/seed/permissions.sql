...
INSERT INTO app.permission (permission, description, category) VALUES
    ...
    ('admin.sync.manage', 'Enable, disable or change caching on individual sync subscriptions', 'admin'),
    ('admin.vocabularies.view', 'View observed open-vocabulary values pending acknowledgement', 'admin'),
    ('admin.vocabularies.acknowledge', 'Acknowledge an observed open-vocabulary value', 'admin'),
    ('admin.webhooks.view', 'View the webhook dead-letter board and outbox backlog', 'admin'),
