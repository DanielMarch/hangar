...
p99 of (platform_call_completed_at − event_at) over 15000 successful revocations: 0.132s against a 60s SLO.

| | |
| :-- | :-- |
| Release | `v1.0.0-rc2` |
| Started | 2026-08-16T21:31:45Z |
| Finished | 2026-08-16T22:03:38Z |
| Duration | 31m54s |
| Drain budget | 1h0m0s |
...
| 2.1 | p99 of (platform_call_completed_at - event_at) < 1m0s | **pass** | p50=0.040s p95=0.091s p99=0.132s max=0.221s over 15000 revocations |
| 2.3 | revocations still owed remain visible with their true age | **pass** | 0 pending, oldest 0.0s old |
| 2.4 | provision-urgent was never starved by provision-bulk — the p99 above was measured with bulk saturated | **pass** | 6 bulk reconcile jobs completed during the run; urgent queue drained: true |
