...
| :-- | :-- |
| Release | `v1.0.0-rc2` |
| Started | 2026-08-17T05:28:43Z |
| Finished | 2026-08-17T09:28:43Z |
| Duration | 4h0m0s |
| Characters | 5000 |
...
| 1.3 | Ledger divergence == 0 tokens after reconciliation, per group | **pass** | max(esi_ledger_divergence) = 0 (group "char-asset") over 10021 group-samples |
| 1.3a | Ledger prediction error recorded (no threshold) | **pass** | max(esi_ledger_prediction_error) = 12 (group "char-social") over 10021 group-samples; recorded as evidence, not bounded |
...
| 1.5 | Failure stayed scoped | **pass** | 1143649 requests served, 1143535 of them 200 while adversarial conditions were active |
...
| 1.6-raw | the weaker reading 1.6 used to be — whether the run served any request AT ALL. Kept so the difference stays visible | **pass** | 1143649 requests reached the proxy over 4h0m0s |
