...
15534 occurrences offered, 13454 events, 13454 deliveries; 0 left neither delivered nor dead-lettered.

| | |
| :-- | :-- |
| Release | `v1.0.0-rc1` |
| Started | 2026-08-16T01:17:53Z |
| Finished | 2026-08-16T05:09:54Z |
| Duration | 3h52m1s |
| Channels | 4 stubs: healthy, transiently-failing, permanently-failing, always-down |
| Coalescing window | 5m0s |
| Dispatch interval | 15s |
| Drain window | 2h15m0s |
| Generate window | 1h45m0s |
...
| :-- | :-- | :-- | :-- |
| 3.1-sample | the run actually generated alerts — "zero dropped" is meaningless over an empty pipeline | **pass** | 15534 occurrences offered (minimum 1000), 13454 events in the database |
...
| 3.1-occurrences | offered == events_written + suppressed_by_dedupe | **pass** | 15534 offered, 13454 written + 2080 deduplicated = 15534 |
