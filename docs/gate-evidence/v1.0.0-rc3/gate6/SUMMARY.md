...
| :-- | :-- |
| Release | `v1.0.0-rc3` |
| Started | 2026-08-21T19:20:05Z |
| Finished | 2026-08-21T19:20:05Z |
| Duration | 0s |
| HEAD | 4d8a8d78aecaa10fda9d18393d20d7d03bdbd506 |
...
| 6.1(d) | an unrecognised x-cache-mode is recorded in app.open_vocabulary, schedules as ttl-based, and the route is NOT rejected | **pass** | cache_mode stored verbatim=true, open_vocabulary cache_mode values=[event-based not-cached quantum-entangled ttl-based], still schedulable=true |
| 6.2-clean | `git status --porcelain` is EMPTY — the ingest required no source change | **pass** | 0 modified paths |
| 6.2-at-tag | `git rev-parse HEAD` equals the release-candidate tag | **pass** | HEAD=4d8a8d78aeca, v1.0.0-rc3=4d8a8d78aeca |
