...
| :-- | :-- |
| Release | `v1.0.0-rc3` |
| Started | 2026-08-21T15:05:25Z |
| Finished | 2026-08-21T19:05:26Z |
| Duration | 4h0m1s |
| Characters | 5000 |
...
| 1.3 | Ledger divergence == 0 tokens after reconciliation, per group | **pass** | max(esi_ledger_divergence) = 0 (group "char-asset") over 30228 group-samples |
| 1.3a | Ledger prediction error recorded (no threshold) | **pass** | max(esi_ledger_prediction_error) = 10 (group "char-detail") over 30228 group-samples; recorded as evidence, not bounded |
...
| 1.5 | Failure stayed scoped | **pass** | 1146665 requests served, 1146551 of them 200 while adversarial conditions were active |
...
| 1.6-raw | the weaker reading 1.6 used to be — whether the run served any request AT ALL. Kept so the difference stays visible | **pass** | 1146665 requests reached the proxy over 4h0m1s |
