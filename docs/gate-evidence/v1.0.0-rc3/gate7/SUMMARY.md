...
34 legacy read routes: 17 served and byte-identical, 0 pending, 15 unshimmable, 2 breaking.

| | |
| :-- | :-- |
| Release | `v1.0.0-rc3` |
| Started | 2026-08-21T02:52:46Z |
| Finished | 2026-08-21T02:53:08Z |
| Duration | 23s |
...
| :-- | :-- | :-- | :-- |
| 7.1 | every served route is byte-identical to its recording (field order, whitespace, numeric formatting and null-vs-absent all in scope) | **pass** | 17 of 17 served routes byte-identical |
...
| 7.8 | unshimmable and pending routes answer 501 — a clear "not shimmed", never a 404 | **pass** | 15 unshimmable + 0 pending, 15 answered 501 |
